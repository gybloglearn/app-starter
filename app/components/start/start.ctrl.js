  ...
  function Controller($cookies, $state, $rootScope) {
    ...
    vm.lista = [
      ...
      {category: 'ZW500',subCategory: 'SheetMaker',
        reports: [
          {title: 'Scrap',picture:'app/components/start/smscrap.jpg',link:'http://3.228.180.15/smscrap/',description:'Lapselejt kimutatások SM-enként, típusonként, hibakódonként, naponta'},
